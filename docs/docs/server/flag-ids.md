...
Your flag IDs fetching script must adhere to one of the templates specified below. If you like to learn by examples, you'll find them at the [bottom of the page](#examples).
